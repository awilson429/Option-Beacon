...
from api.routes import health, market, options_desk, system, trade_desk, trades
...
def create_app(*, service=None) -> FastAPI:
    ...
    for router in (health.router, market.router, trade_desk.router, options_desk.router, trades.router, system.router):
