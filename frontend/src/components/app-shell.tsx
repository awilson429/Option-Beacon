...
const groups = [
  { label:"Trade", items:[["Trade Desk","/",CircleGauge],["SPY / QQQ Options","/options",SlidersHorizontal],["Scanner",null,ScanSearch],["Active Trades",null,Activity],["Journal",null,BookOpen]] },
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen lg:grid lg:grid-cols-[220px_1fr]">
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-[220px] border-r border-slate-800/80 bg-[#080c14] px-4 py-5 lg:block"><Brand/><Navigation/><p className="absolute bottom-5 left-5 text-[9px] uppercase tracking-[.15em] text-slate-700">React migration · Phase 2</p></aside>
