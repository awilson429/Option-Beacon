...
export function AppShell({ children }: { children: React.ReactNode }) {
  const marketCommand=usePathname()==="/";
  ...
  return <div className="min-h-screen lg:grid lg:grid-cols-[220px_minmax(0,1fr)]">
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-[220px] border-r border-slate-800/80 bg-[#080c14] px-4 py-5 lg:block"><Brand/><Navigation/><p className="absolute bottom-5 left-5 text-[9px] uppercase tracking-[.15em] text-slate-700">React migration · Journal</p></aside>
