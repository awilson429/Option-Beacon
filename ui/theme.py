...
def configure_page():
    ...
    theme_css = """
        ...
        .ob-activity-lifecycle {grid-template-columns:7.2rem 3.7rem 3.8rem 2.4rem minmax(5rem,.6fr) minmax(13rem,1.8fr);grid-template-areas:"time tag symbol direction state market" "time tag symbol direction meta meta" "time tag symbol direction details details";align-items:start}.ob-activity-lifecycle .ob-activity-time{grid-area:time}.ob-activity-lifecycle .ob-activity-tag{grid-area:tag}.ob-activity-lifecycle>strong{grid-area:symbol}.ob-activity-lifecycle>b{grid-area:direction}.ob-activity-state{color:var(--ob-gold);font-size:.6rem;font-weight:800;grid-area:state}.ob-activity-market{grid-area:market;white-space:normal}.ob-activity-meta{color:var(--ob-text-muted);font-size:.62rem;grid-area:meta;white-space:normal}.ob-activity-details{grid-area:details}.ob-activity-details summary{color:var(--ob-gold);cursor:pointer;font-size:.58rem}.ob-activity-details div{color:var(--ob-text-muted);font-size:.6rem;padding-top:.2rem;white-space:normal}
        ...
        .ob-compare-grid {display:grid;gap:.65rem;grid-template-columns:repeat(3,minmax(0,1fr));margin-top:.5rem}.ob-compare-column {background:var(--ob-bg-control);border:1px solid var(--ob-border-default);border-radius:7px;padding:.45rem .55rem}.ob-compare-column h4 {color:var(--ob-gold);font-size:.65rem;margin:0 0 .3rem}.ob-compare-column > div {align-items:center;border-bottom:1px solid var(--ob-border-default);display:flex;justify-content:space-between;padding:.18rem 0}.ob-compare-column > div:last-child {border-bottom:0}.ob-compare-column span {color:var(--ob-text-muted);font-size:.62rem}.ob-compare-column strong {color:var(--ob-text-primary);font-size:.68rem}
        .ob-experiment-summary {display:grid;gap:.5rem;grid-template-columns:repeat(2,minmax(0,1fr));margin-top:.5rem}.ob-experiment-metric {align-items:center;background:var(--ob-bg-control);border:1px solid var(--ob-border-default);border-radius:7px;display:grid;gap:.35rem .7rem;grid-template-columns:minmax(6.5rem,1fr) repeat(2,minmax(4.5rem,auto));min-width:0;padding:.38rem .5rem}.ob-experiment-metric>span {color:var(--ob-text-muted);font-size:.56rem;font-weight:800;letter-spacing:.045em}.ob-experiment-metric>div {display:flex;flex-direction:column;min-width:0}.ob-experiment-metric small {color:var(--ob-text-muted);font-size:.52rem}.ob-experiment-metric strong {color:var(--ob-text-primary);font-size:.68rem;white-space:nowrap}
        .ob-auth-summary {display:flex;flex-wrap:wrap;gap:.4rem 1rem;margin-top:.5rem}.ob-auth-summary span {white-space:nowrap}.ob-auth-summary {border-bottom:1px solid var(--ob-border-default);margin:.1rem 0 .45rem;padding-bottom:.4rem}.ob-auth-summary span {color:var(--ob-text-muted);font-size:.62rem}.ob-auth-summary strong {color:var(--ob-text-primary);margin-left:.2rem}
        ...
        .ob-mirror-capital {background:color-mix(in srgb,var(--ob-gold) 6%,var(--ob-bg-control));border:1px solid var(--ob-border-default);border-radius:8px;display:grid;gap:.1rem;margin-top:.5rem;padding:.5rem .65rem}.ob-mirror-capital>span {color:var(--ob-text-muted);font-size:.58rem;font-weight:800;letter-spacing:.04em}.ob-mirror-capital>strong {font-size:1.15rem}.ob-mirror-capital>small {color:var(--ob-text-muted);font-size:.62rem}.ob-mirror-capital>div {display:flex;flex-wrap:wrap;gap:.35rem 1rem;margin-top:.25rem}.ob-mirror-capital>div span {color:var(--ob-text-muted);font-size:.6rem}.ob-mirror-capital>div strong {color:var(--ob-text-primary)}
        ...
        @media (max-width: 759px) {
            ...
            .ob-activity-lifecycle {grid-template-columns:3.7rem minmax(3rem,.7fr) 2.4rem minmax(4rem,1fr);grid-template-areas:"time time time time" "tag symbol direction state" "market market market market" "meta meta meta meta" "details details details details";gap:.28rem .4rem}.ob-activity-lifecycle .ob-activity-time{font-size:.58rem}
            ...
            .ob-experiment-summary {grid-template-columns:minmax(0,1fr)}.ob-experiment-metric {grid-template-columns:minmax(5.5rem,1fr) repeat(2,minmax(4rem,auto))}
